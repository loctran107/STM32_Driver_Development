...
C_SRCS += \
../Src/009SPIMasterArduinoSlave.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/009SPIMasterArduinoSlave.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/009SPIMasterArduinoSlave.d \
./Src/syscalls.d \
./Src/sysmem.d 
...
Src/009SPIMasterArduinoSlave.o: ../Src/009SPIMasterArduinoSlave.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32 -DSTM32F407G_DISC1 -DSTM32F4 -DSTM32F407VGTx -DDEBUG -c -I../Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/009SPIMasterArduinoSlave.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
